...
SECRET_KEY = 'django-insecure-pm-tool-secret-key-change-in-production-2024'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'projectmanager.context_processors.unread_notifications',
            ],
        },
    },
]
...
# Database - SQLite (beginner-friendly default)
DATABASES = {
    'default': {
